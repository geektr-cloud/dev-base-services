external_url 'https://git.{{ service_domain }}'

nginx['listen_port'] = 80
nginx['listen_https'] = false

gitlab_rails['internal_api_url'] = 'https://git.{{ service_domain }}'
...
registry_external_url 'https://registry.{{ service_domain }}'
...
registry['host'] = 'registry.{{ service_domain }}'
registry['storage'] = {
  's3' => {
